...
export default function CartCheckout() {
    ...
    return (
        <> 
            <NavBar />
            <div className="bg-slate-50 shadow-md rounded p-4 sm:p-6 md:p-8 mb-10 mx-2">
            <div id="page" className="flex flex-col md:flex-row w-full mt-40">
        
            <div className="w-full md:w-3/5 md:mx-10">
                <div className="bg-white shadow-md rounded p-4 sm:p-6 mb-10">
                    ...
                    <div className="col-span-2 flex justify-start items-center mt-6 mb-4">
        ...
        <div id="sub" className="bg-white shadow-md rounded w-full md:w-1/5 mt-8 md:mt-0 md:ml-10 py-6 max-h-80 flex flex-col items-center">
