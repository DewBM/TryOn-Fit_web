  ...
  return (
    <>
      ...
      <dialog
        ...
        id="dialog"
        open={isOpen}
        className="z-50 bg-white shadow-md rounded"
        style={{ backdropFilter: "none" }} // Ensure the form is not blurred
      >
        <div className="lg:col-span-6 lg:col-start-4 rounded bg-slate-50 shadow-xl rounded-r-lg pt-4 pb-8 mt-2 mb-2">
          <form
            id={form.id}
            ...
            <div className="grid grid-cols-11">
              ...
              <div className="lg:col-span-4 lg:col-start-7 sm:col-span-1 mt-3">
                <TextBox
                  ...
                  defaultValue={
                    fields.phone.initialValue as React.HTMLInputTypeAttribute
                  }
              ...
              <div className="lg:col-span-4 lg:col-start-2 sm:col-span-2 mt-3">
                <TextBox
                  ...
                  defaultValue={
                    fields.city.initialValue as React.HTMLInputTypeAttribute
                  }
