...
export default function NavBar() {
  return (
    <div className="fixed w-[100%] bg-black mb-9">
      <div className="flex items-center  h-[16vh] justify-between  px-8 ">
        ...
        <div className="flex items-center justify-between ">
          <ul className="md:flex hidden items-center space-x-10 text-white font-semibold text-[18px] ">
            <li>
              <a className="nav_link " href="#Homes">
                New Arrivals
              </a>
            </li>
            <li>
        ...
        w-full p-2 rounded-full bg-slate-50 text-black"
          ...
          <div className="hidden sm:flex pl-10">
            <Button className="bg-white text-main-dark round">
              Try Fit On!
            </Button>
          </div>
          ...
          <Dropdown className="bg-main-lighter">
            ...
            <DropdownMenu aria-label="Static Actions">
              <DropdownItem key="new" className="hover:bg-main-dark">
                {" "}
                <a href="#">Profile</a>
              </DropdownItem>
              <DropdownItem key="edit" className="hover:bg-main-dark">
                {" "}
                <a href="##">Edit</a>
              </DropdownItem>
              <DropdownItem key="notifi" className="hover:bg-main-dark">
