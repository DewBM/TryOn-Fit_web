...
export default function NavBar() {
  ...
  /> 
    ...
    <div className="hidden sm:flex pl-10">
        <Button className="bg-white text-main-dark round" onClick={handleFitOn}>Try Fit On!</Button></div>

<div className="hidden sm:flex pl-10 ">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="size-10 cursor-pointer" onClick={handleAddToCart}>
