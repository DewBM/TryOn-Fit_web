...
//   return (
//     <div
//       className="md:relative h-14 fixed left-4 right-4 bottom-6 z-40 md:inset-0 rounded-full overflow-hidden max-w-md mx-auto ring-main-light "
//       style={{
...
export default function ColorInput({ onColorSubmit }: ColorInputProps) {
  const [color, setColor] = useState("");
