...
import font from "../../../../public/images/MF.png";
import back from "../../../../public/images/MB.png";
              ...
              <div className="lg:col-span-3">
                ...
                <div>
                  {measurements.measurements.includes("chest") && (
                    <hr
                      className={`absolute top-44 mt-7 ml-9 border-1 left-16 w-20 border-red-700 bg-red-700 ${
                        measurements.measurements.includes("chest")
                          ? ""
                          : "hidden"
                      }`}
                  ...
                  {measurements.measurements.includes("west") && (
                    <hr
                      className={`absolute ml-5 top-60 mt-7 border-1 left-20 w-16 border-red-700 bg-red-700${
                        measurements.measurements.includes("west")
                          ? ""
                          : "hidden"
                      }`}
                      style={{ top: "50%", left: "29.5%" }}
                    />
                  )}

                  {measurements.measurements.includes("hip") && (
                    <hr
                      className={`absolute ml-3 top-64 mt-12 border-1 left-20 w-16 border-red-700 bg-red-700${
                        measurements.measurements.includes("hip")
                          ? ""
                          : "hidden"
                      }`}
                  ...
                  {measurements.measurements.includes(
                    ...
                    <hr
                      className={`absolute ml-6 top-80 mt-6 border-1 left-28 w-8 border-red-700 bg-red-700${
                        measurements.measurements.includes(
                          "Thigh_Circumference"
                        )
                          ? ""
                  ...
                  {measurements.measurements.includes("torso") && (
                    <hr
                      ...
                      style={{ top: "38%", left: "33%" }}
                    />
                  )}

                  {measurements.measurements.includes("nseam") && (
                    <hr
                      className={`absolute ml-12 top-64 mt-4 border-1 left-80 h-48 border-red-700 bg-red-700${
                        measurements.measurements.includes("nseam")
                          ? ""
                          : "hidden"
                      }`}
                  ...
                  {measurements.measurements.includes("Calf_Circumference") && (
                    <hr
                      className={`absolute  top-96 mt-14 border-1 left-32 w-6 border-red-700 bg-red-700${
                        measurements.measurements.includes("Calf_Circumference")
                          ? ""
                          : "hidden"
                      }`}
                      style={{ top: "66%", left: "33%" }}
                    />
                  )}

                  {measurements.measurements.includes("sholder") && (
                    <hr
                      className={`absolute  ml-24 top-40 border-1 left-56 w-24 border-red-700 bg-red-700${
                        measurements.measurements.includes("sholder")
                          ? ""
                          : "hidden"
                      }`}
                      style={{ top: "42%", left: "34.5%" }}
                    />
                  )}

                  {measurements.measurements.includes("bicep") && (
                    <hr
                      className={`absolute top-44 mt-7 border-1 left-16 w-5 border-red-700 bg-red-700 ${
                        measurements.measurements.includes("bicep")
                          ? ""
                          : "hidden"
                      }`}
                  ...
                  {measurements.measurements.includes("wrist") && (
                    <hr
                      className={`absolute top-60 mt-9 border-1 left-14 w-3 border-red-700 bg-red-700 ${
                        measurements.measurements.includes("wrist")
                          ? ""
                          : "hidden"
                      }`}
                  ...
                  <div>
                    <button
                      ...
                      onClick={() => {
                        setMeasurements((prevState) => ({
                          ...prevState,
                          measurements: prevState.measurements.includes("wrist")
                            ? prevState.measurements.filter(
                                (m) => m !== "wrist"
                              )
                            : [...prevState.measurements, "wrist"],
                        }));
                      }}
                    >
                      {measurements.measurements.includes("wrist") ? "-" : "+"}
